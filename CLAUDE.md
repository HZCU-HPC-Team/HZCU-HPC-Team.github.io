...
- `scripts/test-site.sh` wires the suite with the Hugo/Go environment. The suite currently has 82 tests covering structure, accessibility, responsive images, animation contracts, and content preservation.
